# 05 — 페르소나 · 페르소나 스펙트럼 분석 방법론

> 본 문서는 05 챕터에서 진행할 **페르소나 계열** 분석의 **기준 프레임**입니다.
> 개별 분석 결과는 이 방법론을 그대로 적용해 별도 문서로 작성합니다.

**이 문서의 범위** — 챕터 구성(페르소나 → 페르소나 스펙트럼 → 고객 여정지도)의 앞 두 주제를 다룹니다. 절 번호는 챕터 구성 순서를 그대로 따릅니다.

| 관련 문서 | 다루는 범위 |
|---|---|
| **`methodology.md` (본 문서)** | **§1 페르소나** (후속 작성 예정) · **§2 페르소나 스펙트럼** ✅ |
| `methodology-customer-journey-map.md` | §3 고객 여정지도 ✅ |
...
> **📄 별도 문서로 분리** — `methodology-customer-journey-map.md`
>
> CJM은 페르소나·스펙트럼과 산출물 형태와 작성 절차가 달라 방법론을 따로 관리한다.
