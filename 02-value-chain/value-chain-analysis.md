...
| 질문 | 이 사업에서의 답 |
|---|---|
| **핵심 공정의 순서와 방식** | 도장은 **한 카페당 1개 · 하루 1회**이므로 12칸을 채우려면 서로 다른 12곳을 방문해야 합니다. 유효기간 1년·선입선출 소멸(스타벅스 별 규칙 준용), 쿠폰은 유효기간 10일. 청구는 **12칸 완성으로 쿠폰이 생기는 순간**에만 발생하고 미완주 도장은 청구하지 않습니다. |
